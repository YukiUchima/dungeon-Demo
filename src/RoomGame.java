...
public class RoomGame {
    ...
    JFrame window;
    Container con;
    JPanel mainPanel, playerPanel, outputPanel, commandPanel, loginPanel, statsPanel, inventoryPanel, keyItemPanel;
    JButton loginBtn, choice1, choice2, choice3, choice4;
    JLabel commandLabel, healthLabel, currentHealthLabel, weaponLabel, currentWeaponLabel, userLabel, passwordLabel;
    JLabel item1Label, item2Label, item3Label, item4Label, key1Lable, key2Label, key3Label;
    JTextField userField, passwordField;
    JTextArea mainTextArea, outputTextArea;
    Border border = new LineBorder(Color.white, 10, true);

    Font outputFont = new Font("Sans Serif", Font.PLAIN, 24);
    Font commandFont = new Font("Serif Plain", Font.PLAIN, 22);
    Font mainText = new Font("Times New Roman", Font.PLAIN, 26);
    Font commonFont = new Font("Times New Roman", Font.PLAIN, 20);
    Font statsFont =  new Font("Serif Plain", Font.PLAIN, 19);

    int playerHP;
    String wpn, position;

    LoginScreenHandler loginHandler = new LoginScreenHandler();
